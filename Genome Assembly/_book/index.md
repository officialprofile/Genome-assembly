...
This mini textbook describes selected algorithms that play a main role in the *de novo* genome assembly. The premise of this book is to construct these algorithms from the very bottom and explain step by step the main ideas that stand behind them.
